     					...
     					<tbody>
     						...
     						<tr>
     							...
     							<td><button type="button" class="btn btn-info btn-sm" data-toggle="modal"
     									data-target="#detail-pengguna-<?= $key->ID_USER;?>">detail</button></td>
     							<td><?= $key->NAMA;?></td>
     							<td><?= $key->EMAIL;?></td>
     						...
     						<div id="detail-pengguna-<?= $key->ID_USER;?>" class="modal fade bs-example-modal-center"
     								...
     								<div class="modal-content">
     									...
     									<div class="modal-body">
     										...
     										<div class="row mb-2 border-bottom pb-1">
     											...
     											<div class="col-8">
     												<span class="text-dark font-weight-normal"><a
     														href="tel:<?= $key->NO_TELP;?>"
     										...
     										<div class="row">
     											...
     											<div class="col-8">
     												<span
     													class="text-dark font-weight-normal"><?= $key->EMAIL;?></span>
     											</div>
     										</div>
     										<hr>
     										<div class="row mb-2 border-bottom pb-1">
     											...
     											<div class="col-8">
     												<span
     													class="text-dark font-weight-normal"><?= $key->USERNAME;?></span>
     											</div>
     										</div>
     										<div class="row">
     											<div class="col-4">
     											...
     											<div class="col-8">
     												<span
     													class="text-dark font-weight-normal"><?= $this->M_admin->get_totalPembelianPengguna($key->ID_USER);?>
     													Pembayaran (Desain & Request)</span>
     											</div>
     										</div>
     									</div>
