     					...
     					<tbody>
     						...
     						<tr>
     							...
     							<td><button type="button" class="btn btn-info btn-sm" data-toggle="modal"
     									data-target="#detail-request-<?= $key->ID_REQUEST;?>">detail</button></td>
     							<td><?= $key->NAMA;?></td>
     							...
     							<div class="modal-dialog modal-lg">
     								<div class="modal-content">
     									<div class="modal-header">
     										<h5 class="modal-title mt-0">Detail request - <span
     												class="text-primary font-weight-medium">#<?= $key->ID_REQUEST;?></span></h5>
     									...
     									<div class="modal-body">
     										...
     										<div class="row mb-3">
     											...
     											<div class="col-4  border-bottom pb-1">
     												<span class="text-dark font-weight-medium"><?= $key->JUDUL;?></span>
     											</div>
     										</div>
     										<div class="row">
     											<div class="col-8">
