            ...
            <div class="card-body">
                <div class="profile-widgets py-3">
                    ...
                    <div class="text-center">
                        <div class="">
                            <img src="<?= base_url();?>assets/backend/images/users/avatar-2.jpg" alt="" class="avatar-lg mx-auto img-thumbnail rounded-circle">
                            <div class="online-circle"><i class="fas fa-circle text-success"></i></div>
                        </div>

                        <div class="mt-3 ">
                            <a href="#" class="text-dark font-weight-medium font-size-16"><?= $desainer->NAMA;?></a>
                            <p class="text-body mt-1 mb-1"><?= empty($desainer->BIDANG) ? 'belum diatur' : $desainer->BIDANG;?></p>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <ui class="list-inline social-source-list">
                                ...
                                <li class="list-inline-item">
                                    <a href="<?= prep_url($desainer->TWITTER);?>" target="_blank" class="avatar-xs">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mt-3">
                    ...
                    <h6 class=""><a href="tel:<?= $desainer->NO_TELP;?>" class="mr-1"><i class="fas fa-phone"></i></a> <?= $desainer->NO_TELP;?></h6>
                </div>
            ...
            <article class="col-6 col-md-4 col-lg-3 mb-4 m-0 p-2">
                ...
                <div class="card card-bordered h-100 shadow-soft transition-3d-hover">
                    ...
                    <div class="card-body" style=" padding: 10px;">
                        ...
                        <ul class="list-inline m-0" style="margin-bottom: -10px"><i class="fas fa-download fa-xs"></i> <?= $key->DIDOWNLOAD;?>
