									...
									<div id="desainer-tentang" class="d-none">
										...
										<div class="form-group">
											...
											<small class="text-danger mb-2">Harap isi informasi pembayaran dengan benar, karena semua
												transaksi pembayaran anda akan dikirim sesuai informasi pembayaran anda. </br> Anda dapat
												menambahkan metode pembayaran lain nanti.</small></br>
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="useratas" name="atas_nama" placeholder="Atas nama">
