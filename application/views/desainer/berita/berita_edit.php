...
<div class="row">
	<div class="col-12">
		<div class="page-title-box d-flex align-items-center justify-content-between">
			<h4 class="page-title mb-0 font-size-18">Edit Berita</h4>
...
<!-- end page title -->
<form action="<?= site_url('desainer/proses_editBerita');?>" method="post" enctype="multipart/form-data">
						...
						<div class="col-9">
							<div class="form-group mb-0">
								<input type="text" class="form-control" name="JUDUL" maxlength="40" required
									value="<?= $berita->JUDUL;?>" id="thresholdconfig" />
							</div>
						</div>
						<div class="col-1">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="form-group">
						<textarea class="form-control w-100" rows="10" name="KONTEN"
							id="richTextArea"><?= $berita->KONTEN;?></textarea>
				...
				<div class="card-body">
					...
					<div class="custom-file">
						...
						<label class="custom-file-label" for="customFile"
							id="fileName"><?= empty($berita->POSTER) ? 'Pilih file' : $berita->POSTER ;?></label>
					</div>
