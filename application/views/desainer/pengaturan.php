             ...
             <div class="card plan-box">
                 <div class="card-body p-4">
                     ...
                     <div class="text-center">
                         <a href="<?= site_url('desainer/pengaturan/informasi-pribadi');?>" class="btn btn-primary waves-effect waves-light">Atur sekarang</a>
                     </div>
         ...
         <div class="col-xl-4 col-md-6">
             <div class="card plan-box">
                 <div class="card-body p-4">
                     ...
                     <div class="text-center">
                         <a href="<?= site_url('desainer/pengaturan/metode-pembayaran');?>" class="btn btn-primary waves-effect waves-light">Atur sekarang</a>
                     </div>
         ...
         <div class="col-xl-4 col-md-6">
             <div class="card plan-box">
                 <div class="card-body p-4">
                     ...
                     <div class="text-center">
                         <a href="<?= site_url('desainer/pengaturan/credentials');?>" class="btn btn-primary waves-effect waves-light">Atur sekarang</a>
                     </div>
