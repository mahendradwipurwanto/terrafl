                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-info btn-sm btn-pill" data-toggle="modal" data-target="#ubah-foto"><i class="fas fa-picture"></i> ubah foto profil</button>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="userAlamat" name="alamat" rows="2" required><?= $info->ALAMAT;?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="userTentang">Tentang <small class="text-danger">*</small></label>
                                <textarea type="text" class="form-control" id="userTentang" name="tentang" rows="3" required><?= $info->TENTANG;?></textarea>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
...
<div id="ubah-foto" class="modal fade bs-example-modal-center"
            ...
            <div class="modal-body pb-0">
              ...
              <div class="form-group mx-auto mb-2">
                ...
                <label for="GETL_FOTO" class="upload-card mx-auto">
                    <img id="L_FOTO" class="upload-img w-100 L_FOTO cursor" src="<?= ($info->PROFIL == "default.png" ? base_url().'assets/frontend/img/others/Pickanimage.png' : base_url().'berkas/profil/desainer/'.$info->ID_USER.'/'.$info->PROFIL);?>" alt="<?= $info->NAMA;?>">
              </label>
              <input type="file" id="GETL_FOTO" class="form-control-file d-none" name="PROFIL"  onchange="previewL_FOTO(this);" accept="image/*">
