     ...
     <div class="row">
     	<div class="col-md-8">
     		<div class="card">
     						...
     						<tr>
     							...
     							<td>
     								<button type="button" class="btn btn-info btn-sm" data-toggle="modal"
     									data-target="#edit-<?= $key->ID_METODE;?>">edit</button>
     								<button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
     									data-target="#hapus-<?= $key->ID_METODE;?>">hapus</button>
     							</td>
     							<td><span
     									class="badge <?php $a = rand(1, 4); if($a == 1){ echo 'badge-primary';}elseif($a == 2){echo 'badge-info'; }elseif($a == 3){echo 'badge-warning';}else{ echo 'badge-orange'; }?>"><?= $key->VIA;?></span>
     							</td>
     							<td><?= $key->ATAS_NAMA;?></td>
     							<td><?= $key->NOMOR;?></td>
     						</tr>
     								...
     								<div class="modal-content">
     									...
     									<div class="modal-body">
     										<form class="form-horizontal"
     											action="<?= site_url('desainer/proses_editMetode/'.$key->ID_METODE);?>"
     											method="POST">
     											<div class="form-group">
     												<small class="text-danger mb-2">Harap isi informasi pembayaran
     													dengan benar, karena semua transaksi pembayaran anda akan
     													dikirim sesuai informasi pembayaran anda.</small></br>
     												<label for="viaPembayaran">Metode Pembayaran <small
     														class="text-danger">*</small></label>
     												<select class="form-control w-100 select2" name="via"
     													id="viaPembayaran" required>
     											...
     											<div class="form-group">
     												<label for="useratas">Atas nama <small
     														class="text-danger">*</small></label>
     												<input type="text" class="form-control" id="useratas"
     													name="atas_nama" value="<?= $key->ATAS_NAMA;?>" required>
     												<small class="text-muted">Nama akun dari metode pembayaran anda
     													yang terdaftar</small>
     											</div>
     											<div class="form-group">
     												<label for="userrekening">Nomor E-Wallet / Nomor Rekening <small
     														class="text-danger">*</small></label>
     												<input type="text" class="form-control" id="userrekening"
     													name="rekening" value="<?= $key->NOMOR;?>" required>
     												<small class="text-muted">Nomor dari e-wallet anda / rekening
     													sesuai dengan metode yang dipilih</small>
     											</div>
     			...
     			<div id="hapus-<?= $key->ID_METODE;?>" class="modal fade bs-example-modal-center" tabindex="-1"
     					...
     					<div class="modal-content">
     						...
     						<div class="modal-body">
     							...
     							<div class="modal-footer mx-0 px-0">
     								...
     								<a href="<?= site_url('desainer/proses_hapusMetode/'.$key->ID_METODE);?>"
     									class="btn btn-danger">hapus metode</a>
     							</div>
     						</div>
     					</div>
     					<!-- /.modal-content -->
     ...
     <div class="col-md-4">
     	<div class="card">
     		<div class="card-body">
     			...
     			<hr>
     			<div>
     				<form class="form-horizontal" action="<?= site_url('desainer/proses_tambahMetode');?>"
     					method="POST">
     					<div class="form-group">
     						<small class="text-danger mb-2">Harap isi informasi pembayaran dengan benar, karena semua
     							transaksi pembayaran anda akan dikirim sesuai informasi pembayaran anda.</small></br>
     					...
     					<div class="form-group">
     						...
     						<small class="text-muted">Nomor dari e-wallet anda / rekening sesuai dengan metode yang
     							dipilih</small>
     					</div>
