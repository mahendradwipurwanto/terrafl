...
<head>
	<meta charset="utf-8" />
	<title> Lupa Password | Terraflair - Design for you</title>
					...
					<div class="card overflow-hidden">
						<div class="bg-login text-center">
							...
							<div class="position-relative">
								...
								<p class="text-white-50 mb-0">Masukkan email akun anda.</p>
						...
						<div class="card-body pt-5">
							...
							<div class="p-2">
								<form class="form-horizontal" action="<?= site_url('masuk/proses_lupa');?>" method="POST">

									<div class="form-group">
										<label for="email">Email</label>
										<input type="email" class="form-control" name="email" id="email"
											placeholder="Masukkan username atau email">
										<small class="text-muted">Link pemulihan password akan kami kirimkan ke email anda</small>
									</div>

									<div class="mt-3">
										<button class="btn btn-primary btn-block waves-effect waves-light" type="submit" id="send-button">Kirim link
											pemulihan password</button>
									</div>
								</form>
							</div>
