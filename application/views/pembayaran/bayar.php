			...
			<div class="row justify-content-center">
				<div class="col-md-8 col-lg-6 col-xl-5">
					<div class="card overflow-hidden">
						<div class="bg-login text-center">
							...
							<div class="position-relative">
								...
								<p class="text-white-50 mb-0"><?= $desain->JUDUL;?></p>
							</div>
						</div>
						<div class="card-body pt-5">
							<div class="p-2">
								<form class="form-horizontal" action="<?= site_url('pembayaran/upload_buktiBayar');?>" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="idPembayaran" value="<?= $pembayaran->ID_PEMBAYARAN;?>" disabled>
										<input type="hidden" name="id_pembayaran" value="<?= $pembayaran->ID_PEMBAYARAN;?>" >
										</div>
									</div>
									<div class="form-group">
										<label for="desain">Desain <small class="text-danger">*</small></label>
										<div class="input-group mb-3">
										<input type="text" class="form-control" id="desain" value="<?= $desain->JUDUL;?>" disabled>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="desainer" value="<?= $desain->NAMA;?>" disabled>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="nominal" value="<?= number_format($pembayaran->NOMINAL,0,",",".");?>" disabled>
									...
									<div class="form-group">
			                            ...
			                            <img id="P_BUKTI" class="upload-img w-100 P_BUKTI cursor" src="<?= base_url() . 'assets/frontend/img/others/Pickanimage.png' ?>" alt="Placeholder">
			                          </label>
			                          <input type="file" id="GETP_BUKTI" class="form-control-file d-none" name="bukti_bayar" onchange="previewP_BUKTI(this);" accept="image/*">
									...
									<div class="form-group">
			                          ...
			                          <textarea type="text" class="form-control" id="catatan" name="catatan" rows="3" placeholder="Tambahkan catatan"></textarea>
			                          <small class="text-muted">Tambahkan catatan jika diperlukan</small>
									</div>

									<div class="mt-4 row">
										<div class="col-3">
										<a href="<?= $this->agent->referrer();?>" class="btn btn-secondary btn-block waves-effect waves-light">batal</a>
										</div>
										<div class="col-9">
					...
					<div class="mt-5 text-center small">
			                          <p class="text-muted">Setelah bukti pembayaran anda diterima oleh desainer, maka anda akan menerima notifikasi dan akses link untuk mendownload desain pesanan anda.</p>
						<p>Harap pastikan bahwa transfer telah berhasil, dan anda memiliki bukti pembayaran berupa foto atau screenshoot dari bukti transfer.
						</p>
					</div>
