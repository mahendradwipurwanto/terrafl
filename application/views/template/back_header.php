	...
	<div class="container-fluid">
		...
		<div id="layout-wrapper">
			...
			<header id="page-topbar">
				...
				<div class="d-flex">
					...
					<div class="dropdown d-inline-block">
						...
						<?php $notif = 0; if($metode == false){$notif = $notif+1;}?>
						<?php if($notif > 0){?>
					...
					<div data-simplebar style="max-height: 230px;">
						<?php if($metode == false){?>
							<a href="<?= site_url('desainer/pengaturan/metode-pembayaran');?>" class="text-reset notification-item">
								<div class="media">
			...
			<div class="dropdown d-inline-block">
				...
				src="<?= ($profil == "default.png" || $profil == false ? base_url().'assets/backend/images/users/avatar-2.jpg' : base_url().'berkas/profil/desainer/'.$this->session->userdata('id_user').'/'.$profil);?>" alt="<?= $this->session->userdata('nama');?>">
